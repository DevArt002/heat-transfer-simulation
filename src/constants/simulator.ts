...
export const DEFAULT_TANK_HEAT_LOSS_COEFFICIENT = 0.2; // Watts per square meter per degree Celsius on surface of storage tank
...
export const DEFAULT_SOLAR_PANEL_HEAT_LOSS_COEFFICIENT = 0.1; // Watts per square meter per degree Celsius on surface of solar panel
export const DEFAULT_PIPE_HEAT_LOSS_COEFFICIENT = 0.01; // Watts per square meter per degree Celsius on surface of pipe line
